...
def scrape_data(url):
    ...
    xpaths = {
        ...
        "download_links": (
            '/html/body/section/div/section/main/div/div[4]/div[2]/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/h3/a/@href | '
            '/html/body/section/div/section/main/div/div[4]/div[2]/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/h4/a/@href | '
            '/html/body/section/div/section/main/div/div[4]/h3/a/@href'
        ),
        "ratings": '/html/body/section/div/section/main/div/div[3]/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div[2]/div/div/div[1]/span/a/text()',
        "trailer_link": '/html/body/section/div/section/main/div/div[5]/iframe/@src',
        "categories": '/html/body/section/div/section/main/div/div[3]/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div[2]/div/div[1]/div[2]/span/text()'
    }
...
# Function to write data to separate CSV files based on the header
def append_data_to_csv(output_folder, data):
    try:
        for header, value in data.items():
            file_path = os.path.join(output_folder, f"{header}.csv")
            ...
            with open(file_path, mode='a', newline='', encoding='utf-8') as file:
                ...
                if file.tell() == 0:
                    writer.writerow([header])  # Write the header only once at the beginning

                # If the value is a list, write each item on a new line
...
if __name__ == "__main__":
    ...
    # Scrape data for each URL and write directly to separate CSV files
    for url in urls:
        ...
        while retries > 0:
            ...
            if scraped_data:
                append_data_to_csv(output_folder, scraped_data)
